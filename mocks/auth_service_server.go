...
func (_m *AuthServiceServer) Login(_a0 context.Context, _a1 *user.LoginRequest) (*user.LoginResponse, error) {
...
func (_m *AuthServiceServer) Register(_a0 context.Context, _a1 *user.RegisterRequest) (*user.RegisterResponse, error) {
	ret := _m.Called(_a0, _a1)
