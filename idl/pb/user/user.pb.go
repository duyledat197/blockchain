...
type GetUserByIDResponse struct {
	...
	Data *common.User `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
}
...
func (x *GetUserByIDResponse) GetData() *common.User {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *GetListUserResponse) GetData() []*common.User {
	if x != nil {
		return x.Data
	}
	return nil
...
type GetUserPrivateKeyByIDRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetUserPrivateKeyByIDRequest) Reset() {
	*x = GetUserPrivateKeyByIDRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetUserPrivateKeyByIDRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUserPrivateKeyByIDRequest) ProtoMessage() {}

func (x *GetUserPrivateKeyByIDRequest) ProtoReflect() protoreflect.Message {
	mi := &file_user_user_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetUserPrivateKeyByIDRequest.ProtoReflect.Descriptor instead.
func (*GetUserPrivateKeyByIDRequest) Descriptor() ([]byte, []int) {
	return file_user_user_proto_rawDescGZIP(), []int{8}
}

func (x *GetUserPrivateKeyByIDRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
type GetUserPrivateKeyByIDResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetUserPrivateKeyByIDResponse) Reset() {
	*x = GetUserPrivateKeyByIDResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetUserPrivateKeyByIDResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUserPrivateKeyByIDResponse) ProtoMessage() {}

func (x *GetUserPrivateKeyByIDResponse) ProtoReflect() protoreflect.Message {
	mi := &file_user_user_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetUserPrivateKeyByIDResponse.ProtoReflect.Descriptor instead.
func (*GetUserPrivateKeyByIDResponse) Descriptor() ([]byte, []int) {
	return file_user_user_proto_rawDescGZIP(), []int{9}
}

func (x *GetUserPrivateKeyByIDResponse) GetPrivateKey() string {
	if x != nil {
		return x.PrivateKey
	}
	return ""
...
func (x *GetUserPrivateKeyByIDResponse) GetNonce() string {
	if x != nil {
		return x.Nonce
	}
	return ""
...
var file_user_user_proto_rawDesc = []byte{
	...
	0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2d, 0x0a, 0x12, 0x47, 0x65,
	0x74, 0x55, 0x73, 0x65, 0x72, 0x42, 0x79, 0x49, 0x44, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x37, 0x0a, 0x13, 0x47, 0x65, 0x74,
	...
	0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x64, 0x61,
	0x74, 0x61, 0x22, 0x35, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72,
	...
	0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0x42, 0x0a, 0x12, 0x47, 0x65, 0x74,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x20, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x03,
	...
	0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0x35, 0x0a, 0x11,
	...
	,
	...
	0x72, 0x5f, 0x69, 0x64, 0x7d, 0x12, 0x60, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72,
	0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x42, 0x79, 0x49, 0x44, 0x12, 0x22,
	0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x50, 0x72, 0x69,
	0x76, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x42, 0x79, 0x49, 0x44, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x23, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65,
	0x72, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x42, 0x79, 0x49, 0x44, 0x52,
	...
	0x0a, 0x07, 0x47, 0x65, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x18, 0x2e, 0x75, 0x73, 0x65, 0x72,
	0x2e, 0x47, 0x65, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75,
	...
	0x73, 0x12, 0x55, 0x0a, 0x0a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12,
	...
	0x76, 0x31, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x73, 0x42, 0x21, 0x5a, 0x1f, 0x6f, 0x70, 0x65, 0x6e,
	0x6d, 0x79, 0x74, 0x68, 0x2f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2f,
	0x69, 0x64, 0x6c, 0x2f, 0x70, 0x62, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_user_user_proto_goTypes = []interface{}{
	...
	(*GetListUserRequest)(nil),            // 4: user.GetListUserRequest
	(*GetListUserResponse)(nil),           // 5: user.GetListUserResponse
	(*UpdateUserRequest)(nil),             // 6: user.UpdateUserRequest
	(*UpdateUserResponse)(nil),            // 7: user.UpdateUserResponse
	(*GetUserPrivateKeyByIDRequest)(nil),  // 8: user.GetUserPrivateKeyByIDRequest
	(*GetUserPrivateKeyByIDResponse)(nil), // 9: user.GetUserPrivateKeyByIDResponse
	(*common.User)(nil),                   // 10: common.User
}
var file_user_user_proto_depIdxs = []int32{
	10, // 0: user.GetUserByIDResponse.data:type_name -> common.User
	10, // 1: user.CreateUserRequest.user:type_name -> common.User
	10, // 2: user.GetListUserResponse.data:type_name -> common.User
	10, // 3: user.UpdateUserRequest.user:type_name -> common.User
	0,  // 4: user.UserService.GetUserByID:input_type -> user.GetUserByIDRequest
	8,  // 5: user.UserService.GetUserPrivateKeyByID:input_type -> user.GetUserPrivateKeyByIDRequest
	2,  // 6: user.UserService.CreateUser:input_type -> user.CreateUserRequest
	4,  // 7: user.UserService.GetList:input_type -> user.GetListUserRequest
	...
	9,  // 10: user.UserService.GetUserPrivateKeyByID:output_type -> user.GetUserPrivateKeyByIDResponse
	3,  // 11: user.UserService.CreateUser:output_type -> user.CreateUserResponse
	5,  // 12: user.UserService.GetList:output_type -> user.GetListUserResponse
...
func file_user_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_user_user_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetUserPrivateKeyByIDRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_user_user_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetUserPrivateKeyByIDResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
